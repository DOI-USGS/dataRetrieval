...
This vignette is being provided in advance of any breaking changes, and more information and guidance will be provided. 
...
This is available as of `dataRetrieval` version 2.7.16. Starting with 2.7.16, all WQP functions default to the newer "WQX3" profiles if available. 

Generally speaking, the following table ROUGHLY shows the conversions of WQX3 to WQX2 mappings:

```{r echo=FALSE, eval=TRUE}
schema <- readr::read_csv("schema_outbound_WQX3.0.csv")
...
This function will continue to work for any service except "qw" (water quality discrete data). HOWEVER, "qw" results will no longer be returned. This function is used to discover what water quality data is available.
