...
x = lapply(findNLDI(nwis = 11109000, nav = c("UT", "DM", "UM", "DD")), sf::st_as_sf)
...
```{r}
str(findNLDI(comid = 101, nav = c("UM", "DM"), no_sf = TRUE), max.level = 1)
```
...
str(findNLDI(comid = 101, nav = "DM", find = c("nwis", "wqp"), distance_km = 200), max.level = 1)
```
