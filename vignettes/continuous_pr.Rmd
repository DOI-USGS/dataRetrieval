...
You can run the target pipeline in parallel in a few different ways (see the [targets documentation](https://books.ropensci.org/targets/)). One way is to use the `future` package. We already added that to the top of the `_targets.R` file:
