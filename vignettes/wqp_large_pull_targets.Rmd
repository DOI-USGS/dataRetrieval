...
```{r echo=FALSE, out.width = "300px", fig.alt = "A screenshot of the log file csv generated by the pipeline. The log file includes a table with the following columns: characteristic name, number of sites, and number of records. The record depcited is for water temperature. It includes 504 sites and 8773 records."}
...
```{r echo=FALSE, out.width = "850px", fig.alt = "A screenshot of the R console output for the example pipeline. The console shows that temperature datadata has been retrieved from 228 sites. It also shows that the records downloaded match the records produced by the pipeline inventory. The output message reads: all good! the expected number of records from the WQP inventory matches the data pull for all characteristics."}
