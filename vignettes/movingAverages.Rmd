...
```{r fig.cap="Simple 30-day moving average daily flow plot using base R", eval=FALSE}
...
```{r fig.cap="Simple 30-day moving average daily flow plot using ggplot2", alt.text = "30-day moving average daily flow plot, no effort on style", message=FALSE, warning=FALSE, fig.height=5, eval=FALSE}
library(ggplot2)
...
```{r fig.cap="Detailed 30-day moving average daily flow plot", alt.text = "30-day moving average daily flow plot", message=FALSE, warning=FALSE, eval=FALSE}
