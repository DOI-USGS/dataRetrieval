...
The `read_USGS_daily` function will eventually replace the `readNWISdv` function. Generally, both functions look pretty similar:
...
dv_modern <- read_USGS_daily(monitoring_location_id = "USGS-01491000",
