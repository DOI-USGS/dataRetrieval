...
# USGS: National Water Information System (NWIS) Overview 
...
## USGS Basic Web Retrievals: readNWISuv example
...
Now let's see what we get back from the `readNWISdata` function:
