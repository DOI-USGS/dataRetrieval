...
`dataRetrieval` provides US water data mainly via 3 sources: National Water Information System (NWIS), Water Quality Portal (WQP), and new or in-development USGS APIs (USGS). WQP is the service for discrete water quality data when you want USGS and other other sources. 
...
* _Prefix_: "read" or "what"
    + Functions that start with "read" will access full data sets
    + Functions that start with "what" will access data availability
* _Middle_: "NWIS", "USGS", "WQP":
    + NWIS functions get data from NWIS web services. All of these service
...
USGS water data comes from the National Water Information System (NWIS). 
