...
1. Get instantaneous USGS discharge data. [Start here](reference/readNWISuv.html)

2. Get daily USGS discharge data. [Start here](reference/readNWISdv.html)

3. Get USGS groundwater data. [Start here](reference/readNWISgwl.html)

4. Get discrete water quality data. Start here[`?readWQPdata`](reference/readWQPdata.html)

4. Discover USGS data (not including discrete water quality data). [Start here](reference/whatNWISdata.html)

6. Discover discrete water quality data. [Start here](reference/readWQPsummary.html)
