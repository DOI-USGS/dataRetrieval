...
access = match.arg(access, c('public','internal','cooperator','USGS'))
  ...
  pkg.env$gwlevels = "http://staging.waterservices.usgs.gov/nwis/gwlevels/"
  pkg.env$measurements = "http://staging.waterdata.usgs.gov/nwis/measurements/"
  pkg.env$peak = "http://staging.waterdata.usgs.gov/usa/nwis/peak/"
