...
#' @param latest_continuous_id `r get_params("continuous")$id`
...
#'                            skipGeometry = TRUE)
#'                         
#' uv_data_period <- read_waterdata_continuous(monitoring_location_id = site,
#'                                   parameter_code = pcode,
#'                                   time = "P7D")
#' 
#' multi_site <- read_waterdata_continuous(monitoring_location_id =  c("USGS-451605097071701",
#'                                                           "USGS-14181500"),
