...
test_that("Construct WQP urls", {
  ...
  expect_equal(
    obs_url_orig,
    "https://www.waterqualitydata.us/wqx3/Result/search?siteid=IIDFG-41WSSPAHS;USGS-02352560&characteristicName=Temperature;Temperature%2C%20sample;Temperature%2C%20water;Temperature%2C%20water%2C%20deg%20F&mimeType=csv&dataProfile=narrow"
  )
