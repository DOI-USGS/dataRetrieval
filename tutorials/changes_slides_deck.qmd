...
::: footer
<https://water.code-pages.usgs.gov/dataRetrieval/articles/continuous_pr.html>
:::
...
qw_data_slim <- qw_data |>
  ...
  mutate(
    Result = if_else(!is.na(DL_cond), DL_val_A, Result_Measure),
